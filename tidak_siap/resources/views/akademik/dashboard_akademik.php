...
<head>
    ...
    <link rel="stylesheet" href="..\..\css\akademik\dashboard_akademik.css">
</head>
<body>
    <div class="header">
    ...
    <div class="container">
            ...
            <div class="status-box">
                ...
                <div class="dosen-info">
                    ...
                    <div class="dosen-details">
                        ...
                        <div><strong>Jabatan:</strong> Akademik</div>
                    </div>
                </div>
                <div class="info-row">
        ...
        <div class="buttons">
            <a href="manajemen_ruangan.php" class="button"><i class="fas fa-university"></i>Manajemen Ruangan</a>
        </div>
    </div>
</body>
</html>

...
<head>
    ...
    <link rel="stylesheet" href="..\..\css\pem_akademik\pembatalan_irs.css">
</head>
<body>
    <!-- Header -->
    <div class="header">
    ...
    <div>
        <h1 class="keterangan">Pembatalan IRS</h1>
    </div>

    <!-- Menu Navigasi -->
    <div class="menu-container">
        <ul class="menu">
            <li><a href="validasi_irs.php">Validasi IRS</a></li>
            <li><a href="#" class="active">Pembatalan IRS</a></li>
        </ul>
    </div>
    ...
    <div class="main-content">
        <div class="content">
            <div class="table-container">
                <h6 style="text-align: center; margin-bottom: 20px;">DAFTAR PEMBATALAN IRS MAHASISWA</h6>

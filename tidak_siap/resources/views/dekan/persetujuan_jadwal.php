...
<head>
    ...
    <link rel="stylesheet" href="..\..\css\dekan\persetujuan_jadwal.css">
</head>
<body>
    <!-- Header -->
    <div class="header">
    ...
    <div>
        <h1 class="keterangan">Persetujuan Jadwal</h1>
    </div>
    ...
    <div class="menu-container">
        <ul class="menu">
        <li><a href="persetujuan_ruangan.php">Persetujuan Ruangan</a></li>
        <li><a href="#" class="active">Persetujuan Jadwal</a></li>
    </div>
    
    <!-- Konten Utama -->
    <div class="main-content">
        <div class="content">
            <h5>DAFTAR RANCANGAN JADWAL KULIAH</h5>

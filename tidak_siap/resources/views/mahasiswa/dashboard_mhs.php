...
<body>
    ...
    <div class="container">
            ...
            <div class="status-box">
                ...
                <div class="dosen-info">
                    ...
                    <div class="dosen-details">
                        <div><strong>Dosen Wali:</strong> Mulyadi S.T., M.Cs</div>
                        <div><strong>NIP:</strong> 12345678910</div>
                    </div>
                </div>
                <div class="info-row">
                    <div>Semester Akademik Sekarang</div>
                    <div>Semester Studi</div>
                    <div>Status</div>
                </div>
                <div class="info-row second-row">
                    <div class="info">2024/2025 Ganjil</div>
                    <div class="info">5</div>
                    <div><span class="status-label">Aktif</span></div>
                </div>
            </div>
            <div class="academic-box">
                <div class="academic-title"><i class="fas fa-trophy"></i> Prestasi Akademik</div>
                <div class="info-row">
                    <div>IPK</div>
                    <div>SKSK</div>
                </div>
                <div class="info-row second-row">
                    <div class="info">3.99</div>
        ...
        <div class="buttons">
            <a href="buat_irs.php" class="button"><i class="fas fa-university"></i> Akademik</a>
            <a href="#" class="button"><i class="fas fa-wallet"></i> Biaya Kuliah dan Registrasi</a>
        </div>
    </div>
</body>
</html>
